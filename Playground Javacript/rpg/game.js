...
function ChooseClasse() {
    ...
    selectMenu.addEventListener('change', function() {
        ...
        if (selectMenu.value === 'Guerreiro') {
            ...
            magoIMG.src = './img/mago.png'; // Caminho da imagem do mago
            magoIMG.width = 200;
